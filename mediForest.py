...
class mediForest():
    ...
    def get_errors(self) -> tuple:
        return_tuple = (
        1 - self.get_score(self.X_train, self.y_train),
        1 - self.get_score(self.X_val, self.y_val),
        1 - self.get_score(self.X_test, self.y_test)
        )
    ...
    def plot_sample_size_curve(self, sample_sizes, test_errors) -> None:
        ...
        plt.grid(True)
        save_fig(plt, "tree_figs", "sample_size_vs_test_error.png")
